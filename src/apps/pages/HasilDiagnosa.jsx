    ...
    <div className="py-20 bg-blue-gray-800">
      ...
      <div className="flex flex-col px-12">
        <div className="bg-white px-5 py-5 rounded-md">
          ...
          <div className="flex flex-col sm:flex-row w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
